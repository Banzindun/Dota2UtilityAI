...
import cz.cuni.mff.kocur.graphics.UserTabs;
 ...
 *
 */
public class AgentTab extends FocusableJPanel {
	/**
	 ...
	 *            Name of the tab.
	 */
	public AgentTab(ExtendedAgentContext context, String tabName) {
		super();
